...
import GestionOrganizacionesScreen from '../screens/SuperAdmin/GestionOrganizacionesScreen';
import AuditoriaScreen from '../screens/SuperAdmin/AuditoriaScreen';
...
export type RootStackParamList = {
  ...
  GestionOrganizaciones: undefined;
  Auditoria: undefined;
};
    ...
    <NavigationContainer>
      <Stack.Navigator
        ...
        <Stack.Screen
          ...
          component={RegisterOrganizationFormScreen}
        />
        ...
        <Stack.Screen
          name="GestionOrganizaciones"
          component={GestionOrganizacionesScreen}
          options={{headerShown: true, title: 'Gestión de Organizaciones'}}
        />
        <Stack.Screen
          name="Auditoria"
          component={AuditoriaScreen}
          options={{headerShown: true, title: 'Auditoría del Sistema'}}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
