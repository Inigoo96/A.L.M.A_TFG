...
CREATE TABLE USUARIO (
    ...
    TIPO_USUARIO VARCHAR(20), -- PACIENTE, PROFESIONAL, ADMIN_ORG
    ...
    CONSTRAINT CK_TIPO_USUARIO CHECK (TIPO_USUARIO IN ('PACIENTE', 'PROFESIONAL', 'ADMIN_ORG'))
);
...
CREATE TABLE PROFESIONAL (
    ...
    ID_USUARIO INTEGER,
    ID_ORGANIZACION INTEGER, -- A qué organización pertenece
    ...
    CONSTRAINT NN_ID_ORGANIZACION_PROF CHECK (ID_ORGANIZACION IS NOT NULL),
    ...
    CONSTRAINT FK_PROFESIONAL_ORGANIZACION FOREIGN KEY (ID_ORGANIZACION) REFERENCES ORGANIZACION(ID_ORGANIZACION)
);
...
CREATE TABLE PACIENTE (
    ...
    CONSTRAINT NN_ID_ORGANIZACION_PAC CHECK (ID_ORGANIZACION IS NOT NULL),
    ...
    CONSTRAINT FK_PACIENTE_ORGANIZACION FOREIGN KEY (ID_ORGANIZACION) REFERENCES ORGANIZACION(ID_ORGANIZACION)
);
